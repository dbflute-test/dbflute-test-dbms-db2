...
public class RegionDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnRegionId = cci("REGION_ID", "REGION_ID", null, "地域ID", Integer.class, "regionId", null, true, false, true, "INTEGER", 10, 0, null, null, false, null, null, null, "memberAddressList", null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.docksidestage.db2.dbflute.exentity.Region"; }
    public String getConditionBeanTypeName() { return "org.docksidestage.db2.dbflute.cbean.RegionCB"; }
    public String getBehaviorTypeName() { return "org.docksidestage.db2.dbflute.exbhv.RegionBhv"; }
