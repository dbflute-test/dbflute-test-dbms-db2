...
public class ProductStatusDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnProductStatusCode = cci("PRODUCT_STATUS_CODE", "PRODUCT_STATUS_CODE", null, "商品ステータスコード", String.class, "productStatusCode", null, true, false, true, "CHAR", 3, 0, null, null, false, null, null, null, "productList,summaryProductList", null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.docksidestage.db2.dbflute.exentity.ProductStatus"; }
    public String getConditionBeanTypeName() { return "org.docksidestage.db2.dbflute.cbean.ProductStatusCB"; }
    public String getBehaviorTypeName() { return "org.docksidestage.db2.dbflute.exbhv.ProductStatusBhv"; }
