...
public class WithdrawalReasonDbm extends AbstractDBMeta {
    ...
    protected final ColumnInfo _columnWithdrawalReasonText = cci("WITHDRAWAL_REASON_TEXT", "WITHDRAWAL_REASON_TEXT", null, "退会理由テキスト", String.class, "withdrawalReasonText", null, false, false, true, "CLOB", 1048576, 0, null, false, null, null, null, null, null, false);
