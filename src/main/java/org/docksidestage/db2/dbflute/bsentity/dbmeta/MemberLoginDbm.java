...
public class MemberLoginDbm extends AbstractDBMeta {
    ...
    protected final ColumnInfo _columnLoginDatetime = cci("LOGIN_DATETIME", "LOGIN_DATETIME", null, "ログイン日時", java.sql.Timestamp.class, "loginDatetime", null, false, false, true, "TIMESTAMP", 26, 6, null, false, null, null, null, null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.docksidestage.db2.dbflute.exentity.MemberLogin"; }
    public String getConditionBeanTypeName() { return "org.docksidestage.db2.dbflute.cbean.MemberLoginCB"; }
    public String getBehaviorTypeName() { return "org.docksidestage.db2.dbflute.exbhv.MemberLoginBhv"; }
