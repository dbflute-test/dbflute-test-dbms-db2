...
public abstract class AbstractBsAliasExceptCQ extends AbstractConditionQuery {
     ...
     */
    public HpSLCFunction<AliasExceptCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, AliasExceptCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<AliasExceptCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, AliasExceptCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<AliasExceptCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, AliasExceptCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<AliasExceptCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, AliasExceptCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<AliasExceptCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, AliasExceptCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<AliasExceptCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, AliasExceptCB.class);
    }
