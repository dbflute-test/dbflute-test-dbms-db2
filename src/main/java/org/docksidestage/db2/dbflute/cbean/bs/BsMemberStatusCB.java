...
public class BsMemberStatusCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<MemberStatusCQ> {
         ...
         * }, AliasMember.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<AliasMemberCB, MemberStatusCQ> derivedAliasMember() {
            assertDerived("aliasMemberList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<AliasMemberCB> sq, MemberStatusCQ cq, String al, DerivedReferrerOption op)
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<AliasMemberLoginCB, MemberStatusCQ> derivedAliasMemberLogin() {
            assertDerived("aliasMemberLoginList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<AliasMemberLoginCB> sq, MemberStatusCQ cq, String al, DerivedReferrerOption op)
