...
public abstract class AbstractBsMemberStatusCQ extends AbstractConditionQuery {
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">existsAliasMember</span>(memberCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     memberCB.query().set...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of AliasMemberList for 'exists'. (NotNull)
     */
    public void existsAliasMember(SubQuery<AliasMemberCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        AliasMemberCB cb = new AliasMemberCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMemberStatusCode_ExistsReferrer_AliasMemberList(cb.query());
    ...
    public void existsAliasMemberLogin(SubQuery<AliasMemberLoginCB> subCBLambda) {
        ...
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMemberStatusCode_ExistsReferrer_AliasMemberLoginList(cb.query());
     ...
     * ALIAS_MEMBER by MEMBER_STATUS_CODE, named 'aliasMemberAsOne'.
     * <pre>
     * cb.query().<span style="color: #CC4747">notExistsAliasMember</span>(memberCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     memberCB.query().set...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of MemberStatusCode_NotExistsReferrer_AliasMemberList for 'not exists'. (NotNull)
     */
    public void notExistsAliasMember(SubQuery<AliasMemberCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        AliasMemberCB cb = new AliasMemberCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMemberStatusCode_NotExistsReferrer_AliasMemberList(cb.query());
     ...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of MemberStatusCode_NotExistsReferrer_AliasMemberLoginList for 'not exists'. (NotNull)
     */
    public void notExistsAliasMemberLogin(SubQuery<AliasMemberLoginCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        AliasMemberLoginCB cb = new AliasMemberLoginCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMemberStatusCode_NotExistsReferrer_AliasMemberLoginList(cb.query());
    ...
    public void xsderiveAliasMemberList(String fn, SubQuery<AliasMemberCB> sq, String al, DerivedReferrerOption op) {
        ...
        lockCall(() -> sq.query(cb)); String pp = keepMemberStatusCode_SpecifyDerivedReferrer_AliasMemberList(cb.query());
    ...
    public void xsderiveAliasMemberLoginList(String fn, SubQuery<AliasMemberLoginCB> sq, String al, DerivedReferrerOption op) {
        ...
        lockCall(() -> sq.query(cb)); String pp = keepMemberStatusCode_SpecifyDerivedReferrer_AliasMemberLoginList(cb.query());
     ...
     * ALIAS_MEMBER by MEMBER_STATUS_CODE, named 'aliasMemberAsOne'.
     * <pre>
     * cb.query().<span style="color: #CC4747">derivedAliasMember()</span>.<span style="color: #CC4747">max</span>(memberCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public HpQDRFunction<AliasMemberCB> derivedAliasMember() {
        return xcreateQDRFunctionAliasMemberList();
    }
    protected HpQDRFunction<AliasMemberCB> xcreateQDRFunctionAliasMemberList() {
        return xcQDRFunc((fn, sq, rd, vl, op) -> xqderiveAliasMemberList(fn, sq, rd, vl, op));
    }
    public void xqderiveAliasMemberList(String fn, SubQuery<AliasMemberCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        AliasMemberCB cb = new AliasMemberCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String sqpp = keepMemberStatusCode_QueryDerivedReferrer_AliasMemberList(cb.query()); String prpp = keepMemberStatusCode_QueryDerivedReferrer_AliasMemberListParameter(vl);
    ...
    public void xqderiveAliasMemberLoginList(String fn, SubQuery<AliasMemberLoginCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        AliasMemberLoginCB cb = new AliasMemberLoginCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String sqpp = keepMemberStatusCode_QueryDerivedReferrer_AliasMemberLoginList(cb.query()); String prpp = keepMemberStatusCode_QueryDerivedReferrer_AliasMemberLoginListParameter(vl);
