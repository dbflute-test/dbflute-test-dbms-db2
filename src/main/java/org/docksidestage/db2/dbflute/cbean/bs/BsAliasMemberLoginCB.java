package org.docksidestage.db2.dbflute.cbean.bs;
...
import org.docksidestage.db2.dbflute.allcommon.DBFluteConfig;
import org.docksidestage.db2.dbflute.allcommon.DBMetaInstanceHandler;
import org.docksidestage.db2.dbflute.allcommon.ImplementedInvokerAssistant;
import org.docksidestage.db2.dbflute.allcommon.ImplementedSqlClauseCreator;
import org.docksidestage.db2.dbflute.cbean.*;
import org.docksidestage.db2.dbflute.cbean.cq.*;
import org.docksidestage.db2.dbflute.cbean.nss.*;
...
public class BsAliasMemberLoginCB extends AbstractConditionBean {
    ...
    public AliasMemberLoginCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected AliasMemberLoginCQ doGetConditionQuery() {
     ...
     */
    public void union(UnionQuery<AliasMemberLoginCB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<AliasMemberLoginCB> unionCBLambda) {
        final AliasMemberLoginCB cb = new AliasMemberLoginCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
     ...
     * <pre>
     * <span style="color: #0000C0">aliasMemberLoginBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">aliasMemberLogin</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">aliasMemberLogin</span>.<span style="color: #CC4747">getMemberStatus()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     */
    ...
    public AliasMemberNss xdfgetNssAliasMember() {
     ...
     * <pre>
     * <span style="color: #0000C0">aliasMemberLoginBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.<span style="color: #CC4747">setupSelect_AliasMember()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">aliasMemberLogin</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">aliasMemberLogin</span>.<span style="color: #CC4747">getAliasMember()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
    ...
    public AliasMemberNss setupSelect_AliasMember() {
        ...
        doSetupSelect(() -> query().queryAliasMember());
    ...
    public static class HpSpecification extends HpAbstractSpecification<AliasMemberLoginCQ> {
        ...
        public AliasMemberCB.HpSpecification specifyAliasMember() {
            ...
            if (_aliasMember == null) {
                _aliasMember = new AliasMemberCB.HpSpecification(_baseCB
                    , xcreateSpQyCall(() -> _qyCall.has() && _qyCall.qy().hasConditionQueryAliasMember()
                                    , () -> _qyCall.qy().queryAliasMember())
                    , _purpose, _dbmetaProvider, xgetSDRFnFc());
                if (xhasSyncQyCall()) { // inherits it
                    _aliasMember.xsetSyncQyCall(xcreateSpQyCall(
                        () -> xsyncQyCall().has() && xsyncQyCall().qy().hasConditionQueryAliasMember()
                      , () -> xsyncQyCall().qy().queryAliasMember()));
                }
            }
            return _aliasMember;
        }
        ...
        public HpSDRFunction<AliasMemberLoginCB, AliasMemberLoginCQ> myselfDerived() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<AliasMemberLoginCB> sq, AliasMemberLoginCQ cq, String al, DerivedReferrerOption op)
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;AliasMemberLoginCB&gt;() {
     ...
     */
    public HpColQyOperand<AliasMemberLoginCB> columnQuery(final SpecifyQuery<AliasMemberLoginCB> colCBLambda) {
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;AliasMemberLoginCB&gt;() {
     ...
     */
    public void orScopeQuery(OrQuery<AliasMemberLoginCB> orCBLambda) {
        xorSQ((AliasMemberLoginCB)this, orCBLambda);
    }
     ...
     *     public void query(AliasMemberLoginCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;AliasMemberLoginCB&gt;() {
     ...
     */
    public void orScopeQueryAndPart(AndQuery<AliasMemberLoginCB> andCBLambda) {
        xorSQAP((AliasMemberLoginCB)this, andCBLambda);
    }
    ...
    protected String xgetConditionBeanClassNameInternally() { return AliasMemberLoginCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return AliasMemberLoginCQ.class.getName(); }
