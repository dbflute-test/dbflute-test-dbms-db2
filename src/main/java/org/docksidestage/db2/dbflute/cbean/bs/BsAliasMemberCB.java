...
public class BsAliasMemberCB extends AbstractConditionBean {
    ...
    public AliasMemberCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected AliasMemberCQ doGetConditionQuery() {
     ...
     */
    public void union(UnionQuery<AliasMemberCB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<AliasMemberCB> unionCBLambda) {
        final AliasMemberCB cb = new AliasMemberCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
     ...
     * <pre>
     * <span style="color: #0000C0">aliasMemberBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">aliasMember</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">aliasMember</span>.<span style="color: #CC4747">getMemberStatus()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<AliasMemberCQ> {
         ...
         * }, AliasMemberLogin.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<AliasMemberLoginCB, AliasMemberCQ> derivedAliasMemberLogin() {
            assertDerived("aliasMemberLoginList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<AliasMemberLoginCB> sq, AliasMemberCQ cq, String al, DerivedReferrerOption op)
        ...
        public HpSDRFunction<AliasMemberCB, AliasMemberCQ> myselfDerived() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<AliasMemberCB> sq, AliasMemberCQ cq, String al, DerivedReferrerOption op)
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;AliasMemberCB&gt;() {
     ...
     */
    public HpColQyOperand<AliasMemberCB> columnQuery(final SpecifyQuery<AliasMemberCB> colCBLambda) {
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;AliasMemberCB&gt;() {
     ...
     */
    public void orScopeQuery(OrQuery<AliasMemberCB> orCBLambda) {
        xorSQ((AliasMemberCB)this, orCBLambda);
    }
     ...
     *     public void query(AliasMemberCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;AliasMemberCB&gt;() {
     ...
     */
    public void orScopeQueryAndPart(AndQuery<AliasMemberCB> andCBLambda) {
        xorSQAP((AliasMemberCB)this, andCBLambda);
    }
    ...
    protected String xgetConditionBeanClassNameInternally() { return AliasMemberCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return AliasMemberCQ.class.getName(); }
