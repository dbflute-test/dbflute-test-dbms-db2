...
public abstract class AbstractBsAliasMemberLoginCQ extends AbstractConditionQuery {
     ...
     */
    public HpSLCFunction<AliasMemberLoginCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, AliasMemberLoginCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<AliasMemberLoginCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, AliasMemberLoginCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<AliasMemberLoginCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, AliasMemberLoginCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<AliasMemberLoginCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, AliasMemberLoginCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<AliasMemberLoginCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, AliasMemberLoginCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;AliasMemberLoginCB&gt;() {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<AliasMemberLoginCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, AliasMemberLoginCB.class);
    }
     ...
     */
    public void myselfExists(SubQuery<AliasMemberLoginCB> subCBLambda) {
