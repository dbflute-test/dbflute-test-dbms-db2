...
public abstract class BsWhiteTargetBhv extends AbstractBehaviorWritable<WhiteTarget, WhiteTargetCB> {
     ...
     * <pre>
     * WhiteTarget whiteTarget = <span style="color: #0000C0">whiteTargetBhv</span>.<span style="color: #CC4747">selectEntity</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     * });
     * <span style="color: #70226C">if</span> (whiteTarget != <span style="color: #70226C">null</span>) { <span style="color: #3F7E5E">// null check</span>
     *     ... = whiteTarget.get...();
     ...
     */
    public WhiteTarget selectEntity(CBCall<WhiteTargetCB> cbLambda) {
     ...
     * WhiteTargetCB cb = <span style="color: #70226C">new</span> WhiteTargetCB();
     * cb.query().setFoo...(value);
     * WhiteTarget whiteTarget = <span style="color: #0000C0">whiteTargetBhv</span>.<span style="color: #DD4747">selectEntity</span>(cb);
     * <span style="color: #70226C">if</span> (whiteTarget != <span style="color: #70226C">null</span>) { <span style="color: #3F7E5E">// null check</span>
     *     ... = whiteTarget.get...();
     * } <span style="color: #70226C">else</span> {
     *     ...
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public WhiteTarget selectByPK(Long targetId) {
        return facadeSelectByPK(targetId);
    }

    protected WhiteTarget facadeSelectByPK(Long targetId) {
