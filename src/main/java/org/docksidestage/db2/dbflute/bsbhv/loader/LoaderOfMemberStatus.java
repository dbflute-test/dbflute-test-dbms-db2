...
public class LoaderOfMemberStatus {
    ...
    //                                                                       Load Referrer
    //                                                                       =============
    protected List<AliasMember> _referrerAliasMember;
     ...
     *     <span style="color: #553000">statusLoader</span>.<span style="color: #CC4747">loadAliasMember</span>(<span style="color: #553000">memberCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public NestedReferrerLoaderGateway<LoaderOfAliasMember> loadAliasMember(ConditionBeanSetupper<AliasMemberCB> refCBLambda) {
        myBhv().loadAliasMember(_selectedList, refCBLambda).withNestedReferrer(refLs -> _referrerAliasMember = refLs);
        return hd -> hd.handle(new LoaderOfAliasMember().ready(_referrerAliasMember, _selector));
    }
     ...
     * <pre>
     * <span style="color: #0000C0">memberStatusBhv</span>.<span style="color: #994747">load</span>(<span style="color: #553000">memberStatusList</span>, <span style="color: #553000">statusLoader</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">statusLoader</span>.<span style="color: #CC4747">loadAliasMemberLogin</span>(<span style="color: #553000">loginCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
