...
public abstract class BsAliasExceptBhv extends AbstractBehaviorWritable<AliasExcept, AliasExceptCB> {
     ...
     * <span style="color: #0000C0">aliasExceptBhv</span>.<span style="color: #CC4747">varyingInsert</span>(aliasExcept, option);
     * ... = aliasExcept.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param aliasExcept The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     <span style="color: #0000C0">aliasExceptBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(aliasExcept, option);
     * } <span style="color: #70226C">catch</span> (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * AliasExceptCB cb = new AliasExceptCB();
     * cb.query().setFoo...(value);
     * UpdateOption&lt;AliasExceptCB&gt; option = <span style="color: #70226C">new</span> UpdateOption&lt;AliasExceptCB&gt;();
     * option.self(new SpecifyQuery&lt;AliasExceptCB&gt;() {
     *     public void specify(AliasExceptCB cb) {
     *         cb.specify().<span style="color: #CC4747">columnFooCount()</span>;
     *     }
     * }).plus(1); <span style="color: #3F7E5E">// FOO_COUNT = FOO_COUNT + 1</span>
     * <span style="color: #0000C0">aliasExceptBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(aliasExcept, cb, option);
     * </pre>
