...
public abstract class BsWhiteRefTargetBhv extends AbstractBehaviorWritable<WhiteRefTarget, WhiteRefTargetCB> {
     ...
     * <pre>
     * WhiteRefTarget whiteRefTarget = <span style="color: #0000C0">whiteRefTargetBhv</span>.<span style="color: #CC4747">selectEntity</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     * });
     * <span style="color: #70226C">if</span> (whiteRefTarget != <span style="color: #70226C">null</span>) { <span style="color: #3F7E5E">// null check</span>
     *     ... = whiteRefTarget.get...();
     ...
     * WhiteRefTargetCB cb = <span style="color: #70226C">new</span> WhiteRefTargetCB();
     * cb.query().setFoo...(value);
     * WhiteRefTarget whiteRefTarget = <span style="color: #0000C0">whiteRefTargetBhv</span>.<span style="color: #DD4747">selectEntity</span>(cb);
     * <span style="color: #70226C">if</span> (whiteRefTarget != <span style="color: #70226C">null</span>) { <span style="color: #3F7E5E">// null check</span>
     *     ... = whiteRefTarget.get...();
     * } <span style="color: #70226C">else</span> {
     *     ...
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public WhiteRefTarget selectByPK(Long refTargetId) {
        return facadeSelectByPK(refTargetId);
    }

    protected WhiteRefTarget facadeSelectByPK(Long refTargetId) {
