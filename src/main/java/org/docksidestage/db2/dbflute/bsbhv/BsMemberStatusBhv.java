...
public abstract class BsMemberStatusBhv extends AbstractBehaviorWritable<MemberStatus, MemberStatusCB> {
     ...
     * <pre>
     * <span style="color: #0000C0">memberStatusBhv</span>.<span style="color: #CC4747">loadAliasMember</span>(<span style="color: #553000">memberStatusList</span>, <span style="color: #553000">memberCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #3F7E5E">//});</span>
     * <span style="color: #70226C">for</span> (MemberStatus memberStatus : <span style="color: #553000">memberStatusList</span>) {
     *     ... = memberStatus.<span style="color: #CC4747">getAliasMemberList()</span>;
     * }
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     ...
     */
    public NestedReferrerListGateway<AliasMember> loadAliasMember(List<MemberStatus> memberStatusList, ConditionBeanSetupper<AliasMemberCB> refCBLambda) {
        xassLRArg(memberStatusList, refCBLambda);
        return doLoadAliasMember(memberStatusList, new LoadReferrerOption<AliasMemberCB, AliasMember>().xinit(refCBLambda));
    }
     ...
     * ALIAS_MEMBER by MEMBER_STATUS_CODE, named 'aliasMemberList'.
     * <pre>
     * <span style="color: #0000C0">memberStatusBhv</span>.<span style="color: #CC4747">loadAliasMember</span>(<span style="color: #553000">memberStatus</span>, <span style="color: #553000">memberCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">memberCB</span>.setupSelect...
     *     <span style="color: #553000">memberCB</span>.query().set...
     *     <span style="color: #553000">memberCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">memberStatus</span>.<span style="color: #CC4747">getAliasMemberList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<AliasMember> loadAliasMember(MemberStatus memberStatus, ConditionBeanSetupper<AliasMemberCB> refCBLambda) {
        xassLRArg(memberStatus, refCBLambda);
        return doLoadAliasMember(xnewLRLs(memberStatus), new LoadReferrerOption<AliasMemberCB, AliasMember>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<AliasMember> loadAliasMember(MemberStatus memberStatus, LoadReferrerOption<AliasMemberCB, AliasMember> loadReferrerOption) {
        xassLRArg(memberStatus, loadReferrerOption);
        return loadAliasMember(xnewLRLs(memberStatus), loadReferrerOption);
    }
    ...
    public NestedReferrerListGateway<AliasMember> loadAliasMember(List<MemberStatus> memberStatusList, LoadReferrerOption<AliasMemberCB, AliasMember> loadReferrerOption) {
        ...
        return doLoadAliasMember(memberStatusList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<AliasMember> doLoadAliasMember(List<MemberStatus> memberStatusList, LoadReferrerOption<AliasMemberCB, AliasMember> option) {
     ...
     * <pre>
     * <span style="color: #0000C0">memberStatusBhv</span>.<span style="color: #CC4747">loadAliasMemberLogin</span>(<span style="color: #553000">memberStatusList</span>, <span style="color: #553000">loginCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #3F7E5E">//});</span>
     * <span style="color: #70226C">for</span> (MemberStatus memberStatus : <span style="color: #553000">memberStatusList</span>) {
     *     ... = memberStatus.<span style="color: #CC4747">getAliasMemberLoginList()</span>;
     * }
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<AliasMemberLogin> loadAliasMemberLogin(List<MemberStatus> memberStatusList, ConditionBeanSetupper<AliasMemberLoginCB> refCBLambda) {
        xassLRArg(memberStatusList, refCBLambda);
        return doLoadAliasMemberLogin(memberStatusList, new LoadReferrerOption<AliasMemberLoginCB, AliasMemberLogin>().xinit(refCBLambda));
    }
     ...
     * ALIAS_MEMBER_LOGIN by LOGIN_MEMBER_STATUS_CODE, named 'aliasMemberLoginList'.
     * <pre>
     * <span style="color: #0000C0">memberStatusBhv</span>.<span style="color: #CC4747">loadAliasMemberLogin</span>(<span style="color: #553000">memberStatus</span>, <span style="color: #553000">loginCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">loginCB</span>.setupSelect...
     *     <span style="color: #553000">loginCB</span>.query().set...
     *     <span style="color: #553000">loginCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">memberStatus</span>.<span style="color: #CC4747">getAliasMemberLoginList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<AliasMemberLogin> loadAliasMemberLogin(MemberStatus memberStatus, ConditionBeanSetupper<AliasMemberLoginCB> refCBLambda) {
        xassLRArg(memberStatus, refCBLambda);
        return doLoadAliasMemberLogin(xnewLRLs(memberStatus), new LoadReferrerOption<AliasMemberLoginCB, AliasMemberLogin>().xinit(refCBLambda));
    }
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<AliasMemberLogin> loadAliasMemberLogin(MemberStatus memberStatus, LoadReferrerOption<AliasMemberLoginCB, AliasMemberLogin> loadReferrerOption) {
        xassLRArg(memberStatus, loadReferrerOption);
        return loadAliasMemberLogin(xnewLRLs(memberStatus), loadReferrerOption);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public NestedReferrerListGateway<AliasMemberLogin> loadAliasMemberLogin(List<MemberStatus> memberStatusList, LoadReferrerOption<AliasMemberLoginCB, AliasMemberLogin> loadReferrerOption) {
        xassLRArg(memberStatusList, loadReferrerOption);
        if (memberStatusList.isEmpty()) { return (NestedReferrerListGateway<AliasMemberLogin>)EMPTY_NREF_LGWAY; }
        return doLoadAliasMemberLogin(memberStatusList, loadReferrerOption);
    }

    protected NestedReferrerListGateway<AliasMemberLogin> doLoadAliasMemberLogin(List<MemberStatus> memberStatusList, LoadReferrerOption<AliasMemberLoginCB, AliasMemberLogin> option) {
