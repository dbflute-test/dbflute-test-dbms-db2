...
public abstract class BsSummaryMemberPurchaseBhv extends AbstractBehaviorWritable<SummaryMemberPurchase, SummaryMemberPurchaseCB> {
     ...
     * <pre>
     * SummaryMemberPurchase summaryMemberPurchase = <span style="color: #0000C0">summaryMemberPurchaseBhv</span>.<span style="color: #CC4747">selectEntity</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     * });
     * <span style="color: #70226C">if</span> (summaryMemberPurchase != <span style="color: #70226C">null</span>) { <span style="color: #3F7E5E">// null check</span>
     ...
     */
    public SummaryMemberPurchase selectEntity(CBCall<SummaryMemberPurchaseCB> cbLambda) {
     ...
     * SummaryMemberPurchaseCB cb = <span style="color: #70226C">new</span> SummaryMemberPurchaseCB();
     * cb.query().setFoo...(value);
     * SummaryMemberPurchase summaryMemberPurchase = <span style="color: #0000C0">summaryMemberPurchaseBhv</span>.<span style="color: #DD4747">selectEntity</span>(cb);
     * <span style="color: #70226C">if</span> (summaryMemberPurchase != <span style="color: #70226C">null</span>) { <span style="color: #3F7E5E">// null check</span>
     *     ... = summaryMemberPurchase.get...();
     * } <span style="color: #70226C">else</span> {
     *     ...
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public SummaryMemberPurchase selectByPK(Integer memberId) {
        return facadeSelectByPK(memberId);
    }

    protected SummaryMemberPurchase facadeSelectByPK(Integer memberId) {
     ...
     * <pre>
     * SummaryMemberPurchase summaryMemberPurchase = <span style="color: #70226C">new</span> SummaryMemberPurchase();
     ...
     * <span style="color: #0000C0">summaryMemberPurchaseBhv</span>.<span style="color: #CC4747">insert</span>(summaryMemberPurchase);
     ...
     * summaryMemberPurchase.<span style="color: #CC4747">setVersionNo</span>(value);
     * <span style="color: #0000C0">summaryMemberPurchaseBhv</span>.<span style="color: #CC4747">update</span>(summaryMemberPurchase);
     * </pre>
     ...
     *     <span style="color: #0000C0">summaryMemberPurchaseBhv</span>.<span style="color: #CC4747">delete</span>(summaryMemberPurchase);
     ...
     * }
     * <span style="color: #0000C0">summaryMemberPurchaseBhv</span>.<span style="color: #CC4747">batchInsert</span>(summaryMemberPurchaseList);
     * </pre>
     ...
     *     summaryMemberPurchaseList.add(summaryMemberPurchase);
     * }
     * <span style="color: #0000C0">summaryMemberPurchaseBhv</span>.<span style="color: #CC4747">batchUpdate</span>(summaryMemberPurchaseList);
     * </pre>
     ...
     * <pre>
     * <span style="color: #0000C0">summaryMemberPurchaseBhv</span>.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;SummaryMemberPurchase, SummaryMemberPurchaseCB&gt;() {
     ...
     */
    public int queryInsert(QueryInsertSetupper<SummaryMemberPurchase, SummaryMemberPurchaseCB> manyArgLambda) {
     ...
     * <span style="color: #0000C0">summaryMemberPurchaseBhv</span>.<span style="color: #CC4747">queryUpdate</span>(summaryMemberPurchase, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public int queryUpdate(SummaryMemberPurchase summaryMemberPurchase, CBCall<SummaryMemberPurchaseCB> cbLambda) {
        return doQueryUpdate(summaryMemberPurchase, createCB(cbLambda), null);
    }
     ...
     * SummaryMemberPurchaseCB cb = <span style="color: #70226C">new</span> SummaryMemberPurchaseCB();
     * cb.query().setFoo...(value);
     * <span style="color: #0000C0">summaryMemberPurchaseBhv</span>.<span style="color: #CC4747">queryUpdate</span>(summaryMemberPurchase, cb);
     * </pre>
     * @param summaryMemberPurchase The entity that contains update values. (NotNull, PrimaryKeyNullAllowed)
     * @param cb The condition-bean of SummaryMemberPurchase. (NotNull)
     * @return The updated count.
     ...
     * <pre>
     * <span style="color: #0000C0">summaryMemberPurchaseBhv</span>.<span style="color: #CC4747">queryDelete</span>(summaryMemberPurchase, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of SummaryMemberPurchase. (NotNull)
     ...
     */
    public int queryDelete(CBCall<SummaryMemberPurchaseCB> cbLambda) {
     ...
     * cb.query().setFoo...(value);
     * <span style="color: #0000C0">summaryMemberPurchaseBhv</span>.<span style="color: #CC4747">queryDelete</span>(summaryMemberPurchase, cb);
     * </pre>
     * @param cb The condition-bean of SummaryMemberPurchase. (NotNull)
     * @return The deleted count.
     * @throws NonQueryDeleteNotAllowedException When the query has no condition.
     ...
     * summaryMemberPurchase.setFoo...(value);
     * summaryMemberPurchase.setBar...(value);
     * <span style="color: #0000C0">summaryMemberPurchaseBhv</span>.<span style="color: #CC4747">varyingInsert</span>(summaryMemberPurchase, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(SummaryMemberPurchase summaryMemberPurchase, WritableOptionCall<SummaryMemberPurchaseCB, InsertOption<SummaryMemberPurchaseCB>> opLambda) {
        doInsert(summaryMemberPurchase, createInsertOption(opLambda));
    }
     ...
     * <span style="color: #0000C0">summaryMemberPurchaseBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(summaryMemberPurchase, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(SummaryMemberPurchase summaryMemberPurchase, WritableOptionCall<SummaryMemberPurchaseCB, UpdateOption<SummaryMemberPurchaseCB>> opLambda) {
        doUpdate(summaryMemberPurchase, createUpdateOption(opLambda));
    }
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(SummaryMemberPurchase summaryMemberPurchase, WritableOptionCall<SummaryMemberPurchaseCB, InsertOption<SummaryMemberPurchaseCB>> insertOpLambda, WritableOptionCall<SummaryMemberPurchaseCB, UpdateOption<SummaryMemberPurchaseCB>> updateOpLambda) {
        doInsertOrUpdate(summaryMemberPurchase, createInsertOption(insertOpLambda), createUpdateOption(updateOpLambda));
    }
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDelete(SummaryMemberPurchase summaryMemberPurchase, WritableOptionCall<SummaryMemberPurchaseCB, DeleteOption<SummaryMemberPurchaseCB>> opLambda) {
        doDelete(summaryMemberPurchase, createDeleteOption(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<SummaryMemberPurchase> summaryMemberPurchaseList, WritableOptionCall<SummaryMemberPurchaseCB, InsertOption<SummaryMemberPurchaseCB>> opLambda) {
        return doBatchInsert(summaryMemberPurchaseList, createInsertOption(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<SummaryMemberPurchase> summaryMemberPurchaseList, WritableOptionCall<SummaryMemberPurchaseCB, UpdateOption<SummaryMemberPurchaseCB>> opLambda) {
        return doBatchUpdate(summaryMemberPurchaseList, createUpdateOption(opLambda));
    }
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<SummaryMemberPurchase> summaryMemberPurchaseList, WritableOptionCall<SummaryMemberPurchaseCB, DeleteOption<SummaryMemberPurchaseCB>> opLambda) {
        return doBatchDelete(summaryMemberPurchaseList, createDeleteOption(opLambda));
    }
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<SummaryMemberPurchase, SummaryMemberPurchaseCB> manyArgLambda, WritableOptionCall<SummaryMemberPurchaseCB, InsertOption<SummaryMemberPurchaseCB>> opLambda) {
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//summaryMemberPurchase.setVersionNo(value);</span>
     * <span style="color: #0000C0">summaryMemberPurchaseBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(summaryMemberPurchase, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     ...
     */
    public int varyingQueryUpdate(SummaryMemberPurchase summaryMemberPurchase, CBCall<SummaryMemberPurchaseCB> cbLambda, WritableOptionCall<SummaryMemberPurchaseCB, UpdateOption<SummaryMemberPurchaseCB>> opLambda) {
        return doQueryUpdate(summaryMemberPurchase, createCB(cbLambda), createUpdateOption(opLambda));
    }
     ...
     * SummaryMemberPurchaseCB cb = <span style="color: #70226C">new</span> SummaryMemberPurchaseCB();
     * cb.query().setFoo...(value);
     * <span style="color: #0000C0">summaryMemberPurchaseBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(summaryMemberPurchase, cb, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">op</span>.self(<span style="color: #553000">colCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *         <span style="color: #553000">colCB</span>.specify().<span style="color: #CC4747">columnFooCount()</span>;
     *     }).plus(1); <span style="color: #3F7E5E">// FOO_COUNT = FOO_COUNT + 1</span>
     * });
     ...
     * @throws NonQueryUpdateNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryUpdate(SummaryMemberPurchase summaryMemberPurchase, SummaryMemberPurchaseCB cb, WritableOptionCall<SummaryMemberPurchaseCB, UpdateOption<SummaryMemberPurchaseCB>> opLambda) {
        return doQueryUpdate(summaryMemberPurchase, cb, createUpdateOption(opLambda));
    }
     ...
     */
    public int varyingQueryDelete(CBCall<SummaryMemberPurchaseCB> cbLambda, WritableOptionCall<SummaryMemberPurchaseCB, DeleteOption<SummaryMemberPurchaseCB>> opLambda) {
     ...
     * @throws NonQueryDeleteNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryDelete(SummaryMemberPurchaseCB cb, WritableOptionCall<SummaryMemberPurchaseCB, DeleteOption<SummaryMemberPurchaseCB>> opLambda) {
