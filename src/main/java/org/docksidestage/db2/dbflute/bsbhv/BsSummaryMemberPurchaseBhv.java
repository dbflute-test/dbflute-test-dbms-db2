...
public abstract class BsSummaryMemberPurchaseBhv extends AbstractBehaviorWritable<SummaryMemberPurchase, SummaryMemberPurchaseCB> {
     ...
     * <span style="color: #0000C0">summaryMemberPurchaseBhv</span>.<span style="color: #CC4747">varyingInsert</span>(summaryMemberPurchase, option);
     * ... = summaryMemberPurchase.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param summaryMemberPurchase The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     <span style="color: #0000C0">summaryMemberPurchaseBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(summaryMemberPurchase, option);
     * } <span style="color: #70226C">catch</span> (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * SummaryMemberPurchaseCB cb = new SummaryMemberPurchaseCB();
     * cb.query().setFoo...(value);
     * UpdateOption&lt;SummaryMemberPurchaseCB&gt; option = <span style="color: #70226C">new</span> UpdateOption&lt;SummaryMemberPurchaseCB&gt;();
     * option.self(new SpecifyQuery&lt;SummaryMemberPurchaseCB&gt;() {
     *     public void specify(SummaryMemberPurchaseCB cb) {
     *         cb.specify().<span style="color: #CC4747">columnFooCount()</span>;
     *     }
     * }).plus(1); <span style="color: #3F7E5E">// FOO_COUNT = FOO_COUNT + 1</span>
     * <span style="color: #0000C0">summaryMemberPurchaseBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(summaryMemberPurchase, cb, option);
     * </pre>
