...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("ALIAS_EXCEPT", "org.docksidestage.db2.dbflute.bsentity.dbmeta.AliasExceptDbm");
        tmpMap.put("ALIAS_MEMBER", "org.docksidestage.db2.dbflute.bsentity.dbmeta.AliasMemberDbm");
        tmpMap.put("ALIAS_MEMBER_LOGIN", "org.docksidestage.db2.dbflute.bsentity.dbmeta.AliasMemberLoginDbm");
        tmpMap.put("ALIAS_REF_EXCEPT", "org.docksidestage.db2.dbflute.bsentity.dbmeta.AliasRefExceptDbm");
        tmpMap.put("MEMBER", "org.docksidestage.db2.dbflute.bsentity.dbmeta.MemberDbm");
        tmpMap.put("MEMBER_ADDRESS", "org.docksidestage.db2.dbflute.bsentity.dbmeta.MemberAddressDbm");
        tmpMap.put("MEMBER_FOLLOWING", "org.docksidestage.db2.dbflute.bsentity.dbmeta.MemberFollowingDbm");
        tmpMap.put("MEMBER_LOGIN", "org.docksidestage.db2.dbflute.bsentity.dbmeta.MemberLoginDbm");
        tmpMap.put("MEMBER_SECURITY", "org.docksidestage.db2.dbflute.bsentity.dbmeta.MemberSecurityDbm");
        tmpMap.put("MEMBER_SERVICE", "org.docksidestage.db2.dbflute.bsentity.dbmeta.MemberServiceDbm");
        tmpMap.put("MEMBER_STATUS", "org.docksidestage.db2.dbflute.bsentity.dbmeta.MemberStatusDbm");
        tmpMap.put("MEMBER_WITHDRAWAL", "org.docksidestage.db2.dbflute.bsentity.dbmeta.MemberWithdrawalDbm");
        tmpMap.put("PRODUCT", "org.docksidestage.db2.dbflute.bsentity.dbmeta.ProductDbm");
        tmpMap.put("PRODUCT_CATEGORY", "org.docksidestage.db2.dbflute.bsentity.dbmeta.ProductCategoryDbm");
        tmpMap.put("PRODUCT_STATUS", "org.docksidestage.db2.dbflute.bsentity.dbmeta.ProductStatusDbm");
        tmpMap.put("PURCHASE", "org.docksidestage.db2.dbflute.bsentity.dbmeta.PurchaseDbm");
        tmpMap.put("REGION", "org.docksidestage.db2.dbflute.bsentity.dbmeta.RegionDbm");
        tmpMap.put("SERVICE_RANK", "org.docksidestage.db2.dbflute.bsentity.dbmeta.ServiceRankDbm");
        tmpMap.put("SUMMARY_PRODUCT", "org.docksidestage.db2.dbflute.bsentity.dbmeta.SummaryProductDbm");
        tmpMap.put("VENDOR_CHECK", "org.docksidestage.db2.dbflute.bsentity.dbmeta.VendorCheckDbm");
        tmpMap.put("WHITE_REF_TARGET", "org.docksidestage.db2.dbflute.bsentity.dbmeta.WhiteRefTargetDbm");
        tmpMap.put("WHITE_TARGET", "org.docksidestage.db2.dbflute.bsentity.dbmeta.WhiteTargetDbm");
        tmpMap.put("WITHDRAWAL_REASON", "org.docksidestage.db2.dbflute.bsentity.dbmeta.WithdrawalReasonDbm");
        tmpMap.put("SUMMARY_MEMBER_PURCHASE", "org.docksidestage.db2.dbflute.bsentity.dbmeta.SummaryMemberPurchaseDbm");
